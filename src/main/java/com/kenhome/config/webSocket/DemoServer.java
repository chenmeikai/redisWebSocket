...
@ServerEndpoint("/websocket/coinTrade/{userId}")
@Component
public class DemoServer {
    ...
    private static CopyOnWriteArraySet<DemoServer> webSocketSet = new CopyOnWriteArraySet<DemoServer>();
